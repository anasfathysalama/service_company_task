                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="type" value="sender">
                                            <label class="form-check-label">sender</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="type" value="biker">
                                            <label class="form-check-label">biker</label>
                                        </div>
                                        @error('type')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
